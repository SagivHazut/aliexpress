...
export const Kids = ({ country, setCountry, setSearchRes, searchRes }) => {
  const name = 'Search in Kids section......'
    ...
    <>
      ...
      <div>
        <Item
          ...
          name={country === 'IL' ? ' ...חיפוש בקטגוריית ילדים' : name}
          searchRes={searchRes}
