...
export const Item = ({
  ...
  // console.log(post[0].lastest_volume === 0)
  // console.log(post[0].evaluate_rate !== undefined)
  // console.log(post[0].discount !== '63%')
  return (
    <>
                ...
                <div className="mx-auto max-w-7xl px-10 lg:px-2">
                  <div className="mx-auto mt-12 grid max-w-2xl grid-cols-2 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-6">
                    {uniquePosts.map((item) => (
                      ...
                      >
                        <a href={item.promotion_link} target="_blank">
                          <div className="relative w-full">
                            <img
                              src={item.product_main_image_url}
                              alt=""
                        ...
                        <div className="max-w-xl">
                          ...
                          <div className="mt-3 flex items-center justify-between text-xs">
                            <a className="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100 ml-0 w-15 h-20">
                              <div>
                                {item.sale_price !== item.original_price ? (
                                  <>
                                    <div>
